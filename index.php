...
if (isset($_POST['submit'])) {
	...
	// Insert quaery
	$sql = "INSERT INTO  tblcontactdata(FullName,PhoneNumber,EmailId,Subject,Message) VALUES(:fname,:phone,:email,:subject,:message)";
...
<head>
	<title>Himalaya College Contact Form</title>
